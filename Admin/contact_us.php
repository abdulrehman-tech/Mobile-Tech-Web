...
?>
    ...
    <div class="sidebar">
      <ul class="sidebar-nav">
        ...
        <li class="sidebar-nav-item">
          <a href="contact_us.php" class="sidebar-nav-link active">
            <div>
                ...
                <?php 
                  ...
                  <tr>
                    <td><?php echo $i?></td>
							      ...
							      <td>
                    <td>
                    <input type="hidden" class="delete_contact_id_value" value="<?php echo $row['id'] ?>">
                    <a class="delete_btn_contact btn btn-danger" href="javascript:void(0)">Delete </a> &nbsp;
                    </td>
                  </tr>
                  <?php  $i++;} ?>
                </tbody>
